...
// quando vc cria um array mesmo que não atribua ele já recebe um valor padrão
...
public class ArraysThings {
	...
	// valor padrão para byte, short, int long float, double é igual a 0
	// valor padrão para char igual a '\u0000' representa um espaço vazio
	// valor padrão para boolean é igual a false
