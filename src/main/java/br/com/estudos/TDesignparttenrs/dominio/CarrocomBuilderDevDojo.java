...
public class CarrocomBuilderDevDojo {
	...
	public CarrocomBuilderDevDojo(String marca, String cor, String placa, Integer velocidadeAtual, char marchaAtual,
	...
	public static final class CarroBuilder {
		...
		public CarrocomBuilderDevDojo build() {
			return new CarrocomBuilderDevDojo(marca, cor, placa, velocidadeAtual, marchaAtual, freioDeMaoPuxado, chaveVirada);
		}
	}
}
